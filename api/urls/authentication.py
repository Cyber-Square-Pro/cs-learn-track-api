...
from api.views import StudentLoginEndPoint, TeacherLoginEndPoint, AdminSignInEndPoint, LogoutEndPoint, RegenerateAccessToken, ValidateRefreshToken
...
urlpatterns = [
    ...
    path('token/verify/', ValidateRefreshToken.as_view())
]
